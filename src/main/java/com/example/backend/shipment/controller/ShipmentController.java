...
public class ShipmentController {
        ...
        public ResponseEntity<ShipmentResponseDto> cancelShipment(@PathVariable Long shipmentId) {
                ShipmentResponseDto dto = shipmentService.cancelShipment(shipmentId);
                return ResponseEntity.ok(dto);
        }
}
